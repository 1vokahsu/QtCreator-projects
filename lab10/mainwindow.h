...
private slots:
    ...
    bool isCorrect();//возвращаем значения корректности при сортировки массива
    ...
    void on_pushButton_removeall_deleteDouble_clicked();
...
private:
    ...
    double *mas = nullptr;
    int size = 0;
    bool allowChange=true, flag_hand=true, flag=true, gl_flag;
